...
version := 1.4 ; v1.4 alpha hotfix -- code has already been changed for v1.4 beta / v1.5 --
...
If (MoveFilterOptions = "1")
{
	...
	WinWait, ahk_class MainWndClass
		WinMove,ahk_class MainWndClass,,% (x + 360), % y3-5
}
}
return
...
Gui, 7: add, text,  y170 x5,MoveGUIs:
...
Gui, 7: add, text, y200 x5, Macrospeed: ; 290
Gui, 7: add, edit,  y200 x100 w120 vMacroSpeed, 150
GuiControl, 7:,Edit3,%macrospeed%

Gui, 7: add, text, y230 x5,Daily: ; 320
Gui, 7: add, text, y260 x5,Weekly: ; 350
Gui, 7: add, text, y290 x5,Monthly: ; 380

Gui, 7: add, DDL, y230 x100 w120 r2 h25 vDaily,0|1
Daily += 1
GuiControl, 7: choose,Combobox4,%Daily% ; 7

Gui, 7: add, DDL, y260 x100 w120 r2 h25 vWeekly ,0|1
Weekly += 1
GuiControl, 7: choose,Combobox5,%Weekly% ; 8

Gui, 7: add, DDL, y290 x100 w120 r2 h25 vMonthly,0|1
Monthly += 1
GuiControl, 7: choose,Combobox6,%Monthly%

Gui, 7: add, text, y320 x5, Default: ; 410
Gui, 7: add, DDL, y320 x100 r3 w120 h25 vDefault,||0|1
	If default = ""
		defaultC = 1
	...
	If default = 0 ; dota
		...
		GuiControl, 7: choose, combobox7,%defaultC% ; 10
		
Gui, 7: add, text, y350 x5, ClearClipboard: ; 440
Gui, 7: add, DDL, y350 x100 w120 r2 vclearclipboard,0|1
...
If clearclipboard = 1
	...
	GuiControl, 7: choose, combobox8,%clearclipboardC% ; 11

Gui, 7: add, text, y380 x5, HeroException: ; 470
Gui, 7: add, DDL, y380 x100 w120 r2 vDisableException,0|1
...
If DisableException = 1
 	...
 	GuiControl, 7: choose, combobox9,%DisableExceptionC%

Gui, 7: add, button, default gSubmit y420 x5 w120 h25, Save and Change ; 500
Gui, 7: add, button, gDefault y420 x150 w120 h25,Erase and Default
OnMessage(0x200, "WM_MOUSEMOVE")
Gui, 7: Show,h460 w500,Settings ; h530
...
If A_GUI = 7 ; settings gui
{
		...
		If (7Control = "Static12") ; ClearClipboard
		...
		If (7Control = "Static13") ; except for
...
^r::
{
	...
	InPutBox,SearchFor,What do you want to remove?,Please enter keyword(s).,,240,100
	If ErrorLevel
		return
	else
	{
