...
WB_counter := 2
test := 10
veto = [System],[CloudGnome],00:00,: ANNOUNCEMENT:,more votes are needed to pass,*** player: [,** Note,<img class,<img id=, votekick ,before the game will automatically,<p id="moreinfoseehelp",
