...
goAll:
{
	...
	Gui, add, DDL, x70 y5 w150 h25 vIndex r7, 12 latest||20 latest|40 latest|60 latest|80 latest|100 latest|120 latest|140 latest|160 latest|180 latest|200 latest
...
InitiateResult:
{
	...
	If (test = 99)
		test := 3
			...
			If (goall_ = "0")
				Gui, %test%: add, ListView,+ReadOnly NoSortHdr altsubmit -vscroll -hscroll w%A_ScreenWidth% h%A_ScreenHeight%,% user "@" gateway ;h610 gcopy
