...
Have fun and for technical support or questions/suggestions, please email me: ProjectDRMF@gmail.com
	...
	Gui, 4: Show, w800 h300 Center,Update - DotA Replay Manager Filter v%version% by aRt)Y
	...
	IfNotExist, %A_workingdir%\icons
{
	...
	;	UrlDownloadToFile,http://pdrmf.googlecode.com/files/update.ico,update.ico
		...
		UrlDownLoadToFile,http://pdrmf.googlecode.com/files/placeholder.ico,placeholder.ico
		Sleep, 1000
				...
				FileMove,%A_workingdir%\placeholder.ico,%A_workingdir%\icons\placeholder.ico
				;Sleep, 1000
		}
}
}
...
If (autoRefresh = "0")
{
	...
	{
		MsgBox,48,Info,The DotA Replay Manager has to be opened and if not already done, a replay has to be chosen to get the needed information for the DRM Filter's full functionality.`n`nMake sure you are using the latest DotA Replay Manager version!`n`nError 1
		return
	}
...
reload:
{
	...
	ControlClick,Button4,ahk_class MainWndClass
...
IniRead,Comment,%A_workingdir%\VersionCheck.ini,VersionCheckMerged,Comment
	...
	FileDelete,VersionCheck.ini	
		...
		If (NewVersion = Version || NewVersion < Version) ; no new
		{
