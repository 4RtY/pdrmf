...
Gui, 7: add, link, y160 +wrap x205 w293,You can edit the hotkeys in the settings.ini to make use of the full power of AutoHotkey.`n• <a HREF="http://www.autohotkey.com/docs/Hotkeys.htm">Hotkey modifier</a>`n• <a HREF="http://www.autohotkey.com/docs/KeyList.htm">Keylist</a>
