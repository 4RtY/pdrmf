...
The changelog can be found on the project page here:
...
start:
{
	...
	url= http://blinkgaming.net/current_games2/_/list/
...
;##################################################################
	...
	If (GN2 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			If A_LoopField contains %GN2%
			{
				counter2++
				found2 := 1
				If counter2 = 1
				{
					global pureGN2 := A_LoopField
					StringReplace,pureGN2,pureGN2,`r,,All
				}
				...
				If counter2 = 2
				{
					...
					StringTrimLeft, slots2, infoGN2, %len2%
					StringTrimLeft, slots2, slots2, 1
					global infoGN2 := pureGN2 A_Space slots2
				}
			}
				
			If (counter2 = 2 && found2 = 1)
			{
				Gui, 2: Default
	...
	If (GN3 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			...
			If A_LoopField contains %GN3%
			{
				counter3++
				found3 := 1
				If counter3 = 1
				{
					global pureGN3 := A_LoopField
					StringReplace,pureGN3,pureGN3,`r,,All
				}
				...
				If counter3 = 2
				{
					...
					StringTrimLeft, slots3, infoGN3, %len3%
					StringTrimLeft, slots3, slots3, 1
					global infoGN3 := pureGN3 A_Space slots3
				}
			}
				
			If (counter3 = 2 && found3 = 1)
			{
				Gui, 2: Default
	...
	If (GN4 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			...
			If A_LoopField contains %GN4%
			{
				counter4++
				found4 := 1
				If counter4 = 1
				{
					global pureGN4 := A_LoopField
					StringReplace,pureGN4,pureGN4,`r,,All
				}
				...
				If counter4 = 2
				{
					...
					StringTrimLeft, slots4, infoGN4, %len4%
					StringTrimLeft, slots4, slots4, 1
					global infoGN4 := pureGN4 A_Space slots4
				}
			}
				
			If (counter4 = 2 && found4 = 1)
			{
				Gui, 2: Default
	...
	If (GN5 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			...
			If A_LoopField contains %GN5%
			{
				counter5++
				found5 := 1
				If counter5 = 1
				{
					global pureGN5 := A_LoopField
					StringReplace,pureGN5,pureGN5,`r,,All
				}
				...
				If counter5 = 2
				{
					...
					StringTrimLeft, slots5, infoGN5, %len5%
					StringTrimLeft, slots5, slots5, 1
					global infoGN5 := pureGN5 A_Space slots5
				}
			}
				
			If (counter5 = 2 && found5 = 1)
			{
				Gui, 2: Default
	...
	If (GN6 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			...
			If A_LoopField contains %GN6%
			{
				counter6++
				found6 := 1
				If counter6 = 1
				{
					global pureGN6 := A_LoopField
					StringReplace,pureGN6,pureGN6,`r,,All
				}
				...
				If counter6 = 2
				{
					...
					StringTrimLeft, slots6, infoGN6, %len6%
					StringTrimLeft, slots6, slots6, 1
					global infoGN6 := pureGN6 A_Space slots6
				}
			}
				
			If (counter6 = 2 && found6 = 1)
			{
				Gui, 2: Default
	...
	If (GN7 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			...
			If A_LoopField contains %GN7%
			{
				counter7++
				found7 := 1
				If counter7 = 1
				{
					global pureGN7 := A_LoopField
					StringReplace,pureGN7,pureGN7,`r,,All
				}
				...
				If counter7 = 2
				{
					...
					StringTrimLeft, slots7, infoGN7, %len7%
					StringTrimLeft, slots7, slots7, 1
					global infoGN7 := pureGN7 A_Space slots7
				}
			}
				
			If (counter7 = 2 && found7 = 1)
			{
				Gui, 2: Default
	...
	If (GN8 != Error)
	{
		...
		Loop, parse, text,`n,`n
		{
			...
			If A_LoopField contains %GN8%
			{
				counter8++
				found8 := 1
				If counter8 = 1
				{
					global pureGN8 := A_LoopField
					StringReplace,pureGN8,pureGN8,`r,,All
				}
				...
				If counter8 = 2
				{
					...
					StringTrimLeft, slots8, infoGN8, %len8%
					StringTrimLeft, slots8, slots8, 1
					global infoGN8 := pureGN8 A_Space slots8
				}
			}
				
			If (counter8 = 2 && found8 = 1)
			{
				Gui, 2: Default
