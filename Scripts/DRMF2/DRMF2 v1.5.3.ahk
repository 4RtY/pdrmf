...
If WinExist("DRM Filter v" version " - DotA") || WinExist("DRM Filter v" version " - ID") || WinExist("Start-Up")
{
...
GoSub, resultcheck
If (useractions != "" && useractions != ">> Normal Log <<`n")
{
...
hacklog = 
	If (HackCheck = "1")
	{
		...
		If (Name2 != "")
		{
			...
			Loop, Read, %logpath%
			{
				If A_loopreadline contains %name2%
				{
					If A_LoopReadLine contains 0x20,0x22,0x23,0x24,0x25,0x26,0x27,0x28,0x29,0x2A,0x2B,0x2C,0x2D,0x2F,0x30,0x31,0x32,0x51
						hacklog = %hacklog%[%A_index%] %A_LoopReadLine%`n
				}
			}
			;msgbox % hacklog
			If (dotachosen = "1")
...
3GuiClose:
IfWinNotExist, DRM Filter v%version% - ID
{
...
2GuiClose:
IfWinNotExist, DRM Filter v%version% - DotA
{
	IniDelete,%settingspath%,Settings,Name
	IniDelete,%settingspath%,Settings,user2
	If LastUsageDate != A_DD
...
Gui, 7: add, DDL, y170 x115 r2 w120 h25 vHackCheck,0|1
	...
	If HackCheck = 1
		HackCheckC = 2
			...
			GuiControl, 7: choose, combobox7,%hackcheckC% ; 7
...
Gui, 7: add, DDL, y200 x115 r2 w120 h25 vEnableECC,0|1
	...
	GuiControl, 7: choose, combobox8,%enableECC_C% ; 8

Gui, 7: add, text, y233 x15, ECCgui:
Gui, 7: add, DDL, y230 x115 r2 w120 h25 vECCgui,0|1
...
Daily += 1
GuiControl, 7: choose,Combobox10,%Daily% ; 10

Gui, 7: add, DDL, y113 x110 w120 r2 h25 vWeekly ,0|1
Weekly += 1
GuiControl, 7: choose,Combobox11,%Weekly% ; 11

Gui, 7: add, DDL, y142 x110 w120 r2 h25 vMonthly,0|1
Monthly += 1
GuiControl, 7: choose,Combobox12,%Monthly%
...
7Guiclose:
{
	...
	If !WinExist("DRM Filter v" version " - DotA") && !WinExist("DRM Filter v" version " - ID") && !WinExist("DRMF Start-Up") && !WinExist("Settings")
		GoSub which
